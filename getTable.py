...
#input an object in an obj file at the objects directory and this code will give
#  the vertex, edge and faces tables you need for rendering it in this program
#  this code will copy the vertex, edge and faces tables to you clipboard so
#  you just need to paste it in the Models.cs file
